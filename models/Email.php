...
class Email extends PHPMailer{
    ...
    protected $gCorreo = 'soportesd-test@outlook.com';
    protected $gContrasena = 'S1st3m4$';
    ...
    public function ticket_abierto($tick_id){
        ...
        foreach ($datos as $row){
            ...
            $idTicketAsig = $row["usu_asig"];                      
        }
        $correoX = $ticket->get_correo_usuario_asignado_soporte($idTicketAsig);
        foreach ($correoX as $Row){
            $correoAsignado= $Row["usu_correo"];
        }
